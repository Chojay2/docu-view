...
export declare class DatasetsService {
    ...
    constructor(prisma: PrismaService, searchService: SearchService, storageService: StorageService);
    ...
    create(createDatasetDto: CreateDatasetDto, userId: string, isAdmin?: boolean): Promise<{
        resources: {
            createdAt: Date;
            updatedAt: Date;
            id: string;
    ...
    createSubmission(createDatasetDto: CreateDatasetDto, userId: string, file?: {
        buffer: Buffer;
        filename: string;
    }): Promise<{
        resources: {
    ...
    approveSubmission(datasetId: string, adminId: string, adminNotes?: string): Promise<{
        resources: {
            createdAt: Date;
            updatedAt: Date;
            id: string;
    ...
    rejectSubmission(datasetId: string, adminId: string, adminNotes: string): Promise<{
        message: string;
    }>;
    update(id: string, updateData: Partial<CreateDatasetDto>): Promise<{
        resources: {
            createdAt: Date;
            updatedAt: Date;
            id: string;
